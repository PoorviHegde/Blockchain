...
def min_block():
    ...
    blockchain.add_transactions(sender = node_address, receiver = 'Poorvi', amount = 1)
    block = blockchain.create_block(proof, previous_hash)
    response = {
        'messsage' : 'Congratulations you just mined a block!',
        'index' : block['index'],
...
#chceking the hash of a block
@app.route('/get_hash')
def get_hash():
    index = int(request.args.get("block_index"))
...
#Add a new transactions to the blockchain
...
#Part3 - Decentralization of blockchain
...
def connect_node():
    ...
    response = {
        "message":"All the nodes are connected. The poohcoin blockchain now contains the following nodes",
...
def replace_chain():
    ...
    if is_chain_replaced:
        ...
        response = {'message': 'All good. This is the longets chain',
